...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LivewatchApi.ApiClient = factory(root.superagent, root.querystring);
  }
   ...
   * @alias module:LivewatchApi/ApiClient
   * @class
   */
  var exports = function() {
     ...
     * @type {String}
     * @default https://www.livewatch.de
     */
    this.basePath = 'https://www.livewatch.de'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'LivewatchToken': {type: 'apiKey', 'in': 'header', name: 'auth-livewatch-token'}
    };
    /**
 ...
 /**
   ...
   * @param {module:LivewatchApi/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
   ...
   * @callback module:LivewatchApi/ApiClient~callApiCallback
   ...
   * @param {module:LivewatchApi/ApiClient~callApiCallback} callback The callback function.
   ...
   * @type {module:LivewatchApi/ApiClient}
   */
