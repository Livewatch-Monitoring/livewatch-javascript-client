...
(function(root, factory) {
  ...
  beforeEach(function() {
    ...
    //instance = new LivewatchApi.CheckStats();
  });
  ...
  describe('CheckStats', function() {
    it('should create an instance of CheckStats', function() {
      // uncomment below and update the code to test CheckStats
      //var instance = new LivewatchApi.CheckStats();
      //expect(instance).to.be.a(LivewatchApi.CheckStats);
    });
