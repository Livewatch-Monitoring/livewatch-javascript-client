...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LivewatchApi.UserApi();
  });
  ...
  describe('UserApi', function() {
    describe('apiTokenDetails', function() {
      it('should call apiTokenDetails successfully', function(done) {
        //uncomment below and update the code to test apiTokenDetails
        //instance.apiTokenDetails(function(error) {
