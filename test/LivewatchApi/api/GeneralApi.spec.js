...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LivewatchApi.GeneralApi();
  });
  ...
  describe('GeneralApi', function() {
    describe('listMonitoringIPs', function() {
      it('should call listMonitoringIPs successfully', function(done) {
        //uncomment below and update the code to test listMonitoringIPs
        //instance.listMonitoringIPs(function(error) {
